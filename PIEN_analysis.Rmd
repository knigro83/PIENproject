...
#ppt_wt x msp
ggplot(data=cor_provclim_long %>% filter(climvar=="ppt_wt"& name=="msp"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("ppt_wt")
...
#vpdmax_sm x PC1
ggplot(data=cor_provclim_long %>% filter(climvar=="vpdmax_sm"& name=="PC1"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("vpdmax_sm")
...
#vpdmax_wt x smrpb
ggplot(data=cor_provclim_long %>% filter(climvar=="vpdmax_sm"& name=="smrpb"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("vpdmax_sm")

vpdmax_sm_smrpb<- cor_provclim_long %>% filter(climvar=="vpdmax_sm" & name=="smrpb") 

vpdmax_sm_smrpb_mod <- lmer(cor ~ value + (1|Provenance), data=vpdmax_sm_smrpb)
plot(vpdmax_sm_smrpb_mod)
qqmath(vpdmax_sm_smrpb_mod)
summary(vpdmax_sm_smrpb_mod)
...
#FDSI x pas
ggplot(data=cor_provclim_long %>% filter(climvar=="FDSI"& name=="pas"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("FDSI")
...
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_value_wt_tmean"& name=="map"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("map x prior_value_wt_tmean cor")

priwttmean_map<- cor_provclim_long %>% filter(climvar=="prior_value_wt_tmean" & name=="map") 

priswtmean_map_mod <- lmer(cor ~ value + (1|Provenance), data=priwttmean_map)
summary(priswtmean_map_mod) #significant

#prior_value_sp_tmax x PC1
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_value_sp_tmax"& name=="PC1"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("PC1 x prior_value_sp_tmax cor")
...
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_value_sp_tmean"& name=="PC1"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("PC1 x prior_value_sp_tmean cor")
...
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_value_sp_tmin"& name=="PC1"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("PC1 x prior_value_sp_tmin cor")
...
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_vpdmax_sp"& name=="map"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
...
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_vpdmax_sp"& name=="pas"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
  ggtitle("prior_vpdmax_sp")
...
#prior_aet_sum x EMT
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_aet_sum"& name=="EMT"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
...
#prior_cwd_wy x TD
ggplot(data=cor_provclim_long %>% filter(climvar=="prior_cwd_wy"& name=="TD"), aes(x=value, y=cor, col=Provenance))+
  geom_point()+
