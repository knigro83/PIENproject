...
plantation_clim <- prov_pcapts %>% filter(Provenance == "Plantation")
...
ggplot(engelmann_clim, aes(x=MAT, y=map))+
  ...
  geom_point(data=plantation_clim, aes(x=MAT, y=map), size=4, col="gold", shape=18)+
  ggrepel::geom_text_repel(data=plantation_clim, aes(label=code))+
