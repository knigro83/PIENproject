...
nffd_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("NFFD")%>% mutate(fit=70), aes(x=NFFD,y=fit), linewidth=1, col="black", sides="b")+
...
shm_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("SHM")%>% mutate(fit=70), aes(x=SHM,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance SHM")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
dd5_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("DD5")%>% mutate(fit=70), aes(x=DD5,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance DD5")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
ext_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("EXT")%>% mutate(fit=70), aes(x=EXT,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance EXT")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
mat_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("MAT")%>% mutate(fit=70), aes(x=MAT,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MAT")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
emt_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("EMT")%>% mutate(fit=70), aes(x=EMT,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance EMT")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
msp_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("MSP")%>% mutate(fit=70), aes(x=MSP,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MSP")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
pptsp_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("PPTsp")%>% mutate(fit=70), aes(x=PPTsp,y=fit), linewidth=1, col="black", sides="b")+
...
mcmt_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("MCMT")%>% mutate(fit=70), aes(x=MCMT,y=fit), linewidth=1, col="black", sides="b")+
...
tavewt_relht_plot <- ggplot()+
  ...
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("Tavewt")%>% mutate(fit=70), aes(x=Tavewt,y=fit), linewidth=1, col="black", sides="b")+
...
ggplot(data=ht_growth_rel_clim_long %>% pivot_wider() %>% filter(!relht>1000), aes(x=MCMT, y=relht))+
  geom_point()+
  geom_smooth(method="lm")
```
