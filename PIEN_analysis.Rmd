...
SR_reldbh_all_mod_plot <- ggplot()+
  ...
  scale_color_manual(values=unname(stepped())[-1], name="Provenance")+
  xlab("Provenance Climate Value")+
  ylab("Sqrt(Basal Area Growth (cm^2))")+
  ggtitle("Southern Region without Gila NF")+
...
NR_linear_ht_plot <- ggplot()+
  ...
  geom_rug(data=ht_NR_long %>% filter(climvar.name %in% unique(NR_linear_mod_df$var))%>% mutate(fit=1) %>% rename(var=climvar.name), aes(x=climvar.value,y=fit, col=Provenance), linewidth=1, sides="b")+
  scale_color_manual(values=unname(stepped())[-c(1:12)])+
  xlab("Provenance Climate Value")+
  ylab("log(Height (m))")+
...
NR_quad_ht_plot <- ggplot()+
  ...
  geom_rug(data=ht_NR_long %>% filter(climvar.name %in% unique(NR_quad_mod_df$var))%>% mutate(fit=1) %>% rename(var=climvar.name), aes(x=climvar.value,y=fit, col=Provenance), linewidth=1, sides="b")+
  scale_color_manual(values=unname(stepped())[-c(1:12)])+
  xlab("Provenance Climate Value")+
  ylab("log(Height (m))")+
  ggtitle("Northern Region")+
...
NR_linear_relht_plot <- ggplot()+
  ...
  geom_rug(data=relht_NR_long %>% filter(name %in% unique(NR_linear_relht_mod_df$var))%>% mutate(fit=10) %>% rename(var=name), aes(x=value,y=fit, col=Provenance), linewidth=1, sides="b")+
  scale_color_manual(values=unname(stepped())[-c(1:12)])+
  xlab("Provenance Climate Value")+
  ylab("Relative Height Growth Rate (%/yr)")+
  ggtitle("Northern Region")+
...
NR_quad_relht_plot <- ggplot()+
  ...
  geom_rug(data=relht_NR_long %>% filter(name %in% unique(NR_quad_relht_mod_df$var))%>% mutate(fit=10) %>% rename(var=name), aes(x=value,y=fit, col=Provenance), linewidth=1, sides="b")+
  scale_color_manual(values=unname(stepped())[-c(1:12)])+
  xlab("Provenance Climate Value")+
  ylab("Relative Height Growth Rate (%/yr)")+
  ggtitle("Northern Region")+
