...
y_max_pptsp_relht_quad_nog = coef(pptsp_relht_mod_lm_nog)[1] + coef(pptsp_relht_mod_lm_nog)[2]*x_relht_DD0_quad + coef(pptsp_relht_mod_lm_nog)[3]*(x_relht_DD0_quad^2)
...
y_max_mcmt_relht_quad_nog = coef(mcmt_relht_mod_lm_nog)[1] + coef(mcmt_relht_mod_lm_nog)[2]*x_relht_DD0_quad + coef(mcmt_relht_mod_lm_nog)[3]*(x_relht_DD0_quad^2)
...
y_max_relht_DD0_nog = coef(transfer_relhtDD0_quad_lm_nog)[1] + coef(transfer_relhtDD0_quad_lm_nog)[2]*x_relht_DD0_quad + coef(transfer_relhtDD0_quad_lm_nog)[3]*(x_relht_DD0_quad^2)
#################
