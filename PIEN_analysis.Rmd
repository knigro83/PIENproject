...
get_pca_ind_results(clim_pca_big$x, big_pca_data, eigenvals_pcabig, clim_pca_big$center, clim_pca_big$scale)
...
png("figures/pc1_pc2_niche_plot.png", width=4, height=4, res=300, units = "in")
pc1_pc2_niche_plot
dev.off()
...
dbh_y_plot <- ggplot()+
  geom_jitter(data=dbh_numeric_time, aes(x=y, y=DBH, col=factor(Provenance, levels=provs_bylat$Provenance), alpha=year), width=.3,height=0)+
