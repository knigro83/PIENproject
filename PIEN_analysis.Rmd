...
for(i in 1:length(climvars)){
  for(j in 1:length(names)){
    ...
    r2.lmer <- performance::r2(mod)$R2_conditional

lmerdata <- bind_rows(lmerdata, data.frame(climvar=climvars[i], name=names[j], pvalue.lmer = pvalue.lmer, r2.lmer=r2.lmer)) 
  }}
...
for(i in 1:length(climvars)){
    ...
    r2.lmer <- performance::rd(mod)$R2_conditional

    
lmerdata_pcs <- bind_rows(lmerdata_pcs, data.frame(climvar=climvars[i], pc1value.lmer = pc1pvalue.lmer, pc2value.lmer = pc2pvalue.lmer, pc1pc2value.lmer = pc1pc2pvalue.lmer, r2.lmer=r2.lmer)) 
}
