...
loadings_pc1pc2 <- as.data.frame(clim_pca_big$rotation)[1:3][c("PAS","PPTat","TD","PPTsm","NFFD","MCMT"),]
...
png("figures/map_and_bigpca.png", width=8.2, height=5.5, res=300, units = "in")
