...
# dev.off()
 ...
 pcaplot2 <- autoplot(clim_pca,x=1,y=3,colour=NA,loadings.colour="gray80", loadings=T, loadings.label=T, loadings.label.colour="darkgrey", scale=0, loadings.label.size=2.5, loadings.label.hjust=1, loadings.label.vjust=1)+
...
ht_dist_plot<- interact_plot(ht_dist_mod_nog, pred=dist.to.plant.3d, modx=geo.dist.to.plant.km, plot.points = TRUE, interval = TRUE, int.width = 0.95, colors="blue2", data=ht_data_clim14)+
