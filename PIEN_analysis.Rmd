...
ggplot(ht_data_aves %>% left_join(provs_bylat), aes(x=y, y=meantotht, col=factor(Provenance, levels=provs_bylat$Provenance)))+
  geom_point(size=3)+
  facet_wrap(~factor(name, levels=c("HT74","HT79","HT85","HT91","HT96","HT06","HT14")),scales="free")+
...
current_climvars <- unique(cor_clean$climvar)[1:26]
...
prior_climvars <- unique(cor_clean$climvar)[27:52]
