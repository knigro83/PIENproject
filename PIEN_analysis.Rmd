...
climmod_cor <- lmer(rw_spline ~ ppt_gs + ppt_wt + vpdmax_sm + vpdmax_fa + vpdmax_sp + prior_ppt_gs + prior_ppt_wt + prior_value_sm_tmin + prior_value_fa_tmin + prior_value_wt_tmin + prior_vpdmax_sm + prior_vpdmax_fa + prior_vpdmax_wt + prior_vpdmax_sp + (1|Provenance), data=growth_climate_df)
plot(climmod_cor)
qqmath(climmod_cor)
summary(climmod_cor)
vif(climmod_cor)
