...
png("figures/map_and_bigpca.png", width=8.2, height=6.5, res=300, units = "in")
...
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="NFFD") %>% filter(!Provenance=="Gila NF")))

####make plot 
nffd_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="NFFD") %>% filter(!Provenance=="Gila NF"))

newdata_nffd_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$NFFD), max(ht_growth_rel_clim_noG$NFFD), length.out=50))
...
nffd_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_nffd_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_nffd_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("NFFD")%>% mutate(fit=10), aes(x=NFFD,y=fit), linewidth=1, col="black", sides="b")+
...
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="bFFP")))
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="bFFP") %>% filter(!Provenance=="Gila NF")))
...
####make plot 
shm_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="SHM") %>% filter(!Provenance=="Gila NF"))

newdata_shm_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$SHM), max(ht_growth_rel_clim_noG$SHM), length.out=50))
...
shm_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_shm_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_shm_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("SHM")%>% mutate(fit=10), aes(x=SHM,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance SHM")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="DD5")))
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="DD5") %>% filter(!Provenance=="Gila NF")))

####make plot 
dd5_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="DD5") %>% filter(!Provenance=="Gila NF"))

newdata_dd5_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$DD5), max(ht_growth_rel_clim_noG$DD5), length.out=50))
dd5_relht_predict <- predict(dd5_relht_mod_lm, newdata = newdata_dd5_relht, interval="confidence")

predictdata_dd5_relht <- cbind(newdata_dd5_relht, dd5_relht_predict) %>% mutate(var="DD5")

dd5_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_dd5_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_dd5_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("DD5")%>% mutate(fit=10), aes(x=DD5,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance DD5")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
####make plot 
ext_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="EXT") %>% filter(!Provenance=="Gila NF"))

newdata_ext_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$EXT), max(ht_growth_rel_clim_noG$EXT), length.out=50))
...
ext_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_ext_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_ext_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("EXT")%>% mutate(fit=10), aes(x=EXT,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance EXT")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="MAT")))
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="MAT") %>% filter(!Provenance=="Gila NF")))

####make plot 
mat_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="MAT") %>% filter(!Provenance=="Gila NF"))

newdata_mat_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$MAT), max(ht_growth_rel_clim_noG$MAT), length.out=50))
mat_relht_predict <- predict(mat_relht_mod_lm, newdata = newdata_mat_relht, interval="confidence")

predictdata_mat_relht <- cbind(newdata_mat_relht, mat_relht_predict) %>% mutate(var="MAT")

mat_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_mat_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_mat_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("MAT")%>% mutate(fit=10), aes(x=MAT,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MAT")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="EMT")))
summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="EMT") %>% filter(!Provenance=="Gila NF")))

####make plot 
emt_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="EMT") %>% filter(!Provenance=="Gila NF"))

newdata_emt_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$EMT), max(ht_growth_rel_clim_noG$EMT), length.out=50))
emt_relht_predict <- predict(emt_relht_mod_lm, newdata = newdata_emt_relht, interval="confidence")

predictdata_emt_relht <- cbind(newdata_emt_relht, emt_relht_predict) %>% mutate(var="EMT")

emt_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_emt_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_emt_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("EMT")%>% mutate(fit=10), aes(x=EMT,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance EMT")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
####make plot 
msp_relht_mod_lm <- lm(relht ~  value, data=ht_growth_rel_clim_long %>% filter(name=="MSP") %>% filter(!Provenance=="Gila NF"))

newdata_msp_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$MSP), max(ht_growth_rel_clim_noG$MSP), length.out=50))
...
msp_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_msp_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_msp_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("MSP")%>% mutate(fit=10), aes(x=MSP,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MSP")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
ggplot(data=ht_growth_rel_clim_noG, aes(x=factor(EXT), y=HT14))+
  geom_boxplot()
ggplot(data=ht_growth_rel_clim_noG, aes(x=factor(NFFD), y=HT14))+
  geom_boxplot()
ggplot(data=ht_growth_rel_clim_noG, aes(x=factor(DD5), y=HT14))+
  geom_boxplot()
ggplot(data=ht_growth_rel_clim_noG, aes(x=factor(SHM), y=HT14))+
  geom_boxplot()


######just 2014 #######
relht_mods14<- data.frame()
for(i in 1:length(provenance_climvars)){
mod <- lmer(relht ~ value + (1|Provenance)+ (1|BLK), data=ht_growth_rel_clim_long %>% filter(name==provenance_climvars[i]) %>% filter(year=="growth14rel"))
pvalue<- as.data.frame(summary(mod)$coefficients)[2,]$`Pr(>|t|)`

mod_nog <- lmer(relht ~ value + (1|Provenance)+ (1|BLK), data=ht_growth_rel_clim_long_nog %>% filter(name==provenance_climvars[i])  %>% filter(year=="growth14rel") %>% filter(!Provenance=="Gila NF"))
pvalue_nog<- as.data.frame(summary(mod_nog)$coefficients)[2,]$`Pr(>|t|)`

relht_mods14 <- bind_rows(relht_mods14, data.frame(var=provenance_climvars[i], pvalue = pvalue, pvalue_nog = pvalue_nog))

}

relht_mods14 %>% arrange(pvalue_nog)

summary(lmer(relht ~ value + (1|Provenance)+ (1|BLK), data=ht_growth_rel_clim_long %>% filter(name=="smrpb") %>% filter(year=="growth14rel")))
...
summary(lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=ht_growth_rel_clim_long_nog %>% filter(name=="PPTsp") %>% filter(!Provenance=="Gila NF")))

####make plot 
pptsp_relht_mod_lm <- lm(relht ~  value + I(value^2), data=ht_growth_rel_clim_long %>% filter(name=="PPTsp") %>% filter(!Provenance=="Gila NF"))

newdata_pptsp_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$PPTsp), max(ht_growth_rel_clim_noG$PPTsp), length.out=50))
pptsp_relht_predict <- predict(pptsp_relht_mod_lm, newdata = newdata_pptsp_relht, interval="confidence")

predictdata_pptsp_relht <- cbind(newdata_pptsp_relht, pptsp_relht_predict) %>% mutate(var="PPTsp")

pptsp_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_pptsp_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_pptsp_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("PPTsp")%>% mutate(fit=10), aes(x=PPTsp,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance PPTsp")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
  theme(legend.position="none")
...
####make plot 
mcmt_relht_mod_lm <- lm(relht ~  value + I(value^2), data=ht_growth_rel_clim_long %>% filter(name=="MCMT") %>% filter(!Provenance=="Gila NF"))

newdata_mcmt_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$MCMT), max(ht_growth_rel_clim_noG$MCMT), length.out=50))
mcmt_relht_predict <- predict(mcmt_relht_mod_lm, newdata = newdata_mcmt_relht, interval="confidence")

predictdata_mcmt_relht <- cbind(newdata_mcmt_relht, mcmt_relht_predict) %>% mutate(var="MCMT")

mcmt_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_mcmt_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_mcmt_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("MCMT")%>% mutate(fit=10), aes(x=MCMT,y=fit), linewidth=1, col="black", sides="b")+
...
####make plot 
tavewt_relht_mod_lm <- lm(relht ~  value + I(value^2), data=ht_growth_rel_clim_long %>% filter(name=="Tavewt") %>% filter(!Provenance=="Gila NF"))

newdata_tavewt_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$Tavewt), max(ht_growth_rel_clim_noG$Tavewt), length.out=50))
tavewt_relht_predict <- predict(tavewt_relht_mod_lm, newdata = newdata_tavewt_relht, interval="confidence")

predictdata_tavewt_relht <- cbind(newdata_tavewt_relht, tavewt_relht_predict) %>% mutate(var="Tavewt")

tavewt_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_tavewt_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_tavewt_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("Tavewt")%>% mutate(fit=10), aes(x=Tavewt,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance Tavewt")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
  theme(legend.position="none")
...
####make plot 
Eref_relht_mod_lm <- lm(relht ~  value + I(value^2), data=ht_growth_rel_clim_long %>% filter(name=="Eref") %>% filter(!Provenance=="Gila NF"))

newdata_Eref_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$Eref), max(ht_growth_rel_clim_noG$Eref), length.out=50))
Eref_relht_predict <- predict(Eref_relht_mod_lm, newdata = newdata_Eref_relht, interval="confidence")

predictdata_Eref_relht <- cbind(newdata_Eref_relht, Eref_relht_predict) %>% mutate(var="Eref")

Eref_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_Eref_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_Eref_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("Eref")%>% mutate(fit=10), aes(x=Eref,y=fit), linewidth=1, col="black", sides="b")+
...
summary(lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="DD0")))
summary(lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=ht_growth_rel_clim_long_nog %>% filter(name=="DD0") %>% filter(!Provenance=="Gila NF")))

####make plot 
DD0_relht_mod_lm <- lm(relht ~  value + I(value^2), data=ht_growth_rel_clim_long %>% filter(name=="DD0") %>% filter(!Provenance=="Gila NF"))

newdata_DD0_relht <-  expand.grid(value=seq(min(ht_growth_rel_clim_noG$DD0), max(ht_growth_rel_clim_noG$DD0), length.out=50))
DD0_relht_predict <- predict(DD0_relht_mod_lm, newdata = newdata_DD0_relht, interval="confidence")

predictdata_DD0_relht <- cbind(newdata_DD0_relht, DD0_relht_predict) %>% mutate(var="DD0")

DD0_relht_plot <- ggplot()+
  geom_ribbon(data=predictdata_DD0_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_DD0_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=ht_growth_rel_clim_noG %>% dplyr::select("DD0")%>% mutate(fit=10), aes(x=DD0,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance DD0")+
  ylab("Relative Height Growth Rate (%/year)")+
  facet_grid(~var)+
  theme_bw()+
...
summary(lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=ht_growth_rel_clim_long %>% filter(name=="EMT")))
summary(lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=ht_growth_rel_clim_long_nog %>% filter(name=="EMT") %>% filter(!Provenance=="Gila NF")))

####make plot 
EMT_relht_mod_lm <- lm(relht ~  value + I(value^2), data=ht_growth_rel_clim_long %>% filter(name=="EMT") %>% filter(!Provenance=="Gila NF"))
...
#bFFP
surv_bFFP_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="bFFP"), family=binomial)
...
##predictions
survbFFP_newdata1 <- expand.grid(climvar.value = seq(min(newdata_bFFP_surv$climvar.value),max(newdata_bFFP_surv$climvar.value),length.out=50),
                                 Provenance = "Pike NF",
                                 BLK = "C",
                                 year=2006)
survbFFP_newdata2 <- cbind(survbFFP_newdata1, predict(surv_bFFP_mod, newdata = survbFFP_newdata1, type = "link", se=TRUE))
...
#without Gila is still significant
surv_bFFP_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="bFFP") %>% filter(!Provenance=="Gila NF"), family=binomial)
summary(surv_bFFP_mod_nog)
#########

#eFFP
surv_eFFP_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="eFFP"), family="binomial")
...
surveFFP_newdata2 <- cbind(surveFFP_newdata1, predict(surv_eFFP_mod, newdata = surveFFP_newdata1, type = "link", se=TRUE))
...
#without Gila is still significant
surv_eFFP_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="eFFP") %>% filter(!Provenance=="Gila NF"), family="binomial")
...
ggplot(survsmrpb_nog_newdata3, aes(x = climvar.value, y = PredictedProb)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  geom_point(aes(x=climvar.value, y=PredictedProb))+
  xlab("smrpb")
...
surv_ind_plot_data<- bind_rows(survcmd_newdata3 %>% mutate(climvar.name="CMD"),
survFFP_newdata3 %>% mutate(climvar.name="FFP"),
survEref_newdata3 %>% mutate(climvar.name="Eref"),
survsmrpb_newdata3 %>% mutate(climvar.name="smrpb"))
...
SR_ht_PPTwt_quad_lm <- lm(value ~ climvar.value + I(climvar.value^2), data=ht_SR_long %>% filter(climvar.name=="PPTwt"))
...
SR_MAT_plot<- ggplot()+
  ...
  xlab("MAT")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_SR_long %>% filter(name=="MAT")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
SR_MAT_plot

##Tavewt
SR_relhtTavewt_quad <- lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=relht_SR_long %>% filter(name=="Tavewt"))
plot(SR_relhtTavewt_quad)
qqmath(SR_relhtTavewt_quad)
summary(SR_relhtTavewt_quad)

SR_relhtTavewt_quad_lm <- lm(relht ~ value + I(value^2), data=relht_SR_long %>% filter(name=="Tavewt"))
newdata_SR_relhtTavewt <- with(relht_SR_long %>% filter(name=="Tavewt"), data.frame(value=seq(min(value),max(value),length.out=100)))

SR_relhtTavewt_predict <- predict(SR_relhtTavewt_quad_lm, newdata = newdata_SR_relhtTavewt, interval="confidence")

predictdata_SR_relhtTavewt <- cbind(newdata_SR_relhtTavewt, SR_relhtTavewt_predict)

SR_Tavewt_plot<- ggplot()+
  geom_ribbon(data=predictdata_SR_relhtTavewt, aes(x=value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_SR_relhtTavewt, aes(x=value,y=fit), color="black")+
  xlab("Tavewt")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_SR_long %>% filter(name=="Tavewt")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
SR_Tavewt_plot

##DD0
SR_relhtDD0_quad <- lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=relht_SR_long %>% filter(name=="DD0"))
plot(SR_relhtDD0_quad)
qqmath(SR_relhtDD0_quad)
summary(SR_relhtDD0_quad)

SR_relhtDD0_quad_lm <- lm(relht ~ value + I(value^2), data=relht_SR_long %>% filter(name=="DD0"))
newdata_SR_relhtDD0 <- with(relht_SR_long %>% filter(name=="DD0"), data.frame(value=seq(min(value),max(value),length.out=100)))

SR_relhtDD0_predict <- predict(SR_relhtDD0_quad_lm, newdata = newdata_SR_relhtDD0, interval="confidence")

predictdata_SR_relhtDD0 <- cbind(newdata_SR_relhtDD0, SR_relhtDD0_predict)

SR_DD0_plot<- ggplot()+
  geom_ribbon(data=predictdata_SR_relhtDD0, aes(x=value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_SR_relhtDD0, aes(x=value,y=fit), color="black")+
  xlab("DD0")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_SR_long %>% filter(name=="DD0")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
SR_DD0_plot

##DD18
SR_relhtDD18_quad <- lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=relht_SR_long %>% filter(name=="DD18"))
plot(SR_relhtDD18_quad)
qqmath(SR_relhtDD18_quad)
summary(SR_relhtDD18_quad)

SR_relhtDD18_quad_lm <- lm(relht ~ value + I(value^2), data=relht_SR_long %>% filter(name=="DD18"))
newdata_SR_relhtDD18 <- with(relht_SR_long %>% filter(name=="DD18"), data.frame(value=seq(min(value),max(value),length.out=100)))

SR_relhtDD18_predict <- predict(SR_relhtDD18_quad_lm, newdata = newdata_SR_relhtDD18, interval="confidence")

predictdata_SR_relhtDD18 <- cbind(newdata_SR_relhtDD18, SR_relhtDD18_predict)

SR_DD18_plot<- ggplot()+
  geom_ribbon(data=predictdata_SR_relhtDD18, aes(x=value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_SR_relhtDD18, aes(x=value,y=fit), color="black")+
  xlab("DD18")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_SR_long %>% filter(name=="DD18")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
SR_DD18_plot
```
...
predictdata_SR_dbhRH <- cbind(newdata_SR_dbhRH, SR_dbhRH_predict)
...
predictdata_SR_dbhTD <- cbind(newdata_SR_dbhTD, SR_dbhTD_predict)
...
predictdata_SR_dbhsmrpb <- cbind(newdata_SR_dbhsmrpb, SR_dbhsmrpb_predict)
...
predictdata_dbh_pptwt <- cbind(newdata_dbh_pptwt, dbh_pptwt_predict)
...
predictdata_SR_reldbhRH <- cbind(newdata_SR_reldbhRH, SR_reldbhRH_predict)
...
predictdata_SR_reldbhTD <- cbind(newdata_SR_reldbhTD, SR_reldbhTD_predict)
...
predictdata_SR_reldbhPPTwt <- cbind(newdata_SR_reldbhPPTwt, SR_reldbhPPTwt_predict)
...
ht_NR_mods %>% arrange(pvalue) ##a bunch are significant, but not the 3 that were significant for the southern region. 

##MAT
NR_ht_MAT_mod <- lmer(log(value) ~ climvar.value + (1|Provenance) + (1|BLK) + (1|year), data=ht_NR_long %>% filter(climvar.name=="MAT"))
plot(NR_ht_MAT_mod)
qqmath(NR_ht_MAT_mod)
summary(NR_ht_MAT_mod)

####make plot 
NR_MAT_ht_mod_lm <- lm(log(value) ~  climvar.value, data=ht_NR_long %>% filter(climvar.name=="MAT"))

newdata_NR_MAT_ht <-  expand.grid(climvar.value=seq(min(ht_NR_long %>% filter(climvar.name=="MAT") %>% pull(climvar.value)), max(ht_NR_long %>% filter(climvar.name=="MAT") %>% pull(climvar.value)),length.out=50))
NR_MAT_ht_predict <- predict(NR_MAT_ht_mod_lm, newdata = newdata_NR_MAT_ht, interval="confidence")

predicMATata_MAT_ht <- cbind(newdata_NR_MAT_ht, NR_MAT_ht_predict) %>% mutate(var="MAT")

NR_MAT_ht_plot <- ggplot()+
  geom_ribbon(data=predicMATata_MAT_ht, aes(x=climvar.value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predicMATata_MAT_ht, aes(x=climvar.value,y=fit), color="black")+
  geom_rug(data=ht_NR_long %>% filter(climvar.name=="MAT")%>% mutate(fit=1), aes(x=climvar.value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MAT")+
  ylab("Height (m)")+
  facet_grid(~var)+
  theme_bw()+
...
##MCMT
ht_MCMT_mod <- lmer(log(value) ~ climvar.value + (1|Provenance) + (1|BLK) + (1|year), data=ht_NR_long %>% filter(climvar.name=="MCMT"))
plot(ht_MCMT_mod)
qqmath(ht_MCMT_mod)
summary(ht_MCMT_mod)

####make plot 
NR_MCMT_ht_mod_lm <- lm(log(value) ~  climvar.value, data=ht_NR_long %>% filter(climvar.name=="MCMT"))

newdata_NR_MCMT_ht <-  expand.grid(climvar.value=seq(min(ht_NR_long %>% filter(climvar.name=="MCMT") %>% pull(climvar.value)), max(ht_NR_long %>% filter(climvar.name=="MCMT") %>% pull(climvar.value)), length.out=50))
NR_MCMT_ht_predict <- predict(NR_MCMT_ht_mod_lm, newdata = newdata_NR_MCMT_ht, interval="confidence")

predicMCMTata_MCMT_ht <- cbind(newdata_NR_MCMT_ht, NR_MCMT_ht_predict) %>% mutate(var="MCMT")

NR_MCMT_ht_plot <- ggplot()+
  geom_ribbon(data=predicMCMTata_MCMT_ht, aes(x=climvar.value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predicMCMTata_MCMT_ht, aes(x=climvar.value,y=fit), color="black")+
  geom_rug(data=ht_NR_long %>% filter(climvar.name=="MCMT")%>% mutate(fit=1), aes(x=climvar.value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MCMT")+
  ylab("Height (m)")+
  facet_grid(~var)+
  theme_bw()+
...
ht_NR_mods_quad %>% arrange(pvalue2) #a lot of precip vars have quadratic effects
...
predictdata_NR_htmap <- cbind(newdata_NR_htmap, NR_htmap_predict)
...
##PAS
NR_ht_PAS_quad <- lmer(log(value) ~ climvar.value + I(climvar.value^2) + (1|Provenance) + (1|BLK)+(1|year), data=ht_NR_long %>% filter(climvar.name=="PAS"))
plot(NR_ht_PAS_quad)
qqmath(NR_ht_PAS_quad)
summary(NR_ht_PAS_quad)

NR_ht_PAS_quad_lm <- lm(value ~ climvar.value + I(climvar.value^2), data=ht_NR_long %>% filter(climvar.name=="PAS"))
newdata_NR_ht_PAS <- with(ht_NR_long %>% filter(climvar.name=="PAS"), data.frame(climvar.value=seq(min(climvar.value),max(climvar.value),length.out=100)))

NR_ht_PAS_predict <- predict(NR_ht_PAS_quad_lm, newdata = newdata_NR_ht_PAS, interval="confidence")

predictdata_NR_ht_PAS <- cbind(newdata_NR_ht_PAS, NR_ht_PAS_predict)

NR_PAS_plot<- ggplot()+
  geom_ribbon(data=predictdata_NR_ht_PAS, aes(x=climvar.value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_NR_ht_PAS, aes(x=climvar.value,y=fit), color="black")+
  geom_rug(data=ht_NR_long %>% filter(climvar.name=="PAS")%>% mutate(fit=3), aes(x=climvar.value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("PAS")+
  ylab("log(Height)")+
  scale_color_manual(values=unname(stepped()),name="Provenance")+
  theme_bw()
...
NR_ht_MCMT_quad_lm <- lm(value ~ climvar.value + I(climvar.value^2), data=ht_NR_long %>% filter(climvar.name=="MCMT"))
...
predictdata_NR_ht_MCMT <- cbind(newdata_NR_ht_MCMT, NR_ht_MCMT_predict)
...
##MSP
NR_ht_MSP_quad <- lmer(log(value) ~ climvar.value + I(climvar.value^2) + (1|Provenance) + (1|BLK)+(1|year), data=ht_NR_long %>% filter(climvar.name=="MSP"))
plot(NR_ht_MSP_quad)
qqmath(NR_ht_MSP_quad)
summary(NR_ht_MSP_quad)

NR_ht_MSP_quad_lm <- lm(value ~ climvar.value + I(climvar.value^2), data=ht_NR_long %>% filter(climvar.name=="MSP"))
newdata_NR_ht_MSP <- with(ht_NR_long %>% filter(climvar.name=="MSP"), data.frame(climvar.value=seq(min(climvar.value),max(climvar.value),length.out=100)))

NR_ht_MSP_predict <- predict(NR_ht_MSP_quad_lm, newdata = newdata_NR_ht_MSP, interval="confidence")

predictdata_NR_ht_MSP <- cbind(newdata_NR_ht_MSP, NR_ht_MSP_predict)

NR_MSP_plot<- ggplot()+
  geom_ribbon(data=predictdata_NR_ht_MSP, aes(x=climvar.value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_NR_ht_MSP, aes(x=climvar.value,y=fit), color="black")+
  geom_rug(data=ht_NR_long %>% filter(climvar.name=="MSP")%>% mutate(fit=3), aes(x=climvar.value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("MSP")+
  ylab("log(Height)")+
  scale_color_manual(values=unname(stepped()),name="Provenance")+
  theme_bw()
...
relht_NR_mods %>% arrange(pvalue) ##lots significant
...
##AHM
NR_relht_AHM_mod <- lmer(relht ~ value + (1|Provenance) + (1|BLK) + (1|year), data=relht_NR_long %>% filter(name=="AHM"))
plot(NR_relht_AHM_mod)
qqmath(NR_relht_AHM_mod)
summary(NR_relht_AHM_mod)

####make plot 
NR_AHM_relht_mod_lm <- lm(relht ~  value, data=relht_NR_long %>% filter(name=="AHM"))

newdata_NR_AHM_relht <-  expand.grid(value=seq(min(relht_NR_long %>% filter(name=="AHM") %>% pull(value)), max(relht_NR_long %>% filter(name=="AHM") %>% pull(value)), length.out=50))
NR_AHM_relht_predict <- predict(NR_AHM_relht_mod_lm, newdata = newdata_NR_AHM_relht, interval="confidence")

predicAHMata_AHM_relht <- cbind(newdata_NR_AHM_relht, NR_AHM_relht_predict) %>% mutate(var="AHM")

NR_AHM_relht_plot <- ggplot()+
  geom_ribbon(data=predicAHMata_AHM_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predicAHMata_AHM_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=relht_NR_long %>% filter(name=="AHM")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance AHM")+
  ylab("Relative Height Growth Rate (%/yr)")+
  facet_grid(~var)+
  theme_bw()+
...
##MAT
NR_relht_MAT_mod <- lmer(relht ~ value + (1|Provenance) + (1|BLK) + (1|year), data=relht_NR_long %>% filter(name=="MAT"))
plot(NR_relht_MAT_mod)
qqmath(NR_relht_MAT_mod)
summary(NR_relht_MAT_mod)

####make plot 
NR_MAT_relht_mod_lm <- lm(relht ~  value, data=relht_NR_long %>% filter(name=="MAT"))

newdata_NR_MAT_relht <-  expand.grid(value=seq(min(relht_NR_long %>% filter(name=="MAT") %>% pull(value)), max(relht_NR_long %>% filter(name=="MAT") %>% pull(value)), length.out=50))
NR_MAT_relht_predict <- predict(NR_MAT_relht_mod_lm, newdata = newdata_NR_MAT_relht, interval="confidence")

predicMATata_MAT_relht <- cbind(newdata_NR_MAT_relht, NR_MAT_relht_predict) %>% mutate(var="MAT")

NR_MAT_relht_plot <- ggplot()+
  geom_ribbon(data=predicMATata_MAT_relht, aes(x=value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predicMATata_MAT_relht, aes(x=value,y=fit), color="black")+
  geom_rug(data=relht_NR_long %>% filter(name=="MAT")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance MAT")+
  ylab("Relative Height Growth Rate (%/yr)")+
  facet_grid(~var)+
  theme_bw()+
...
relht_NR_mods_quad %>% arrange(pvalue2) #DD0, DD18, MAT, Tavewt are significant
...
predictdata_NR_relhtMAP <- cbind(newdata_NR_relhtMAP, NR_relhtMAP_predict)
...
predictdata_NR_relhtMCMT <- cbind(newdata_NR_relhtMCMT, NR_relhtMCMT_predict)
...
##PAS
NR_relhtPAS_quad <- lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=relht_NR_long %>% filter(name=="PAS"))
plot(NR_relhtPAS_quad)
qqmath(NR_relhtPAS_quad)
summary(NR_relhtPAS_quad)

NR_relhtPAS_quad_lm <- lm(relht ~ value + I(value^2), data=relht_NR_long %>% filter(name=="PAS"))
newdata_NR_relhtPAS <- with(relht_NR_long %>% filter(name=="PAS"), data.frame(value=seq(min(value),max(value),length.out=100)))

NR_relhtPAS_predict <- predict(NR_relhtPAS_quad_lm, newdata = newdata_NR_relhtPAS, interval="confidence")

predictdata_NR_relhtPAS <- cbind(newdata_NR_relhtPAS, NR_relhtPAS_predict)

NR_PAS_plot<- ggplot()+
  geom_ribbon(data=predictdata_NR_relhtPAS, aes(x=value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_NR_relhtPAS, aes(x=value,y=fit), color="black")+
  xlab("PAS")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_NR_long %>% filter(name=="PAS")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
NR_PAS_plot

##Eref
NR_relhtEref_quad <- lmer(relht ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=relht_NR_long %>% filter(name=="Eref"))
plot(NR_relhtEref_quad)
qqmath(NR_relhtEref_quad)
summary(NR_relhtEref_quad)

NR_relhtEref_quad_lm <- lm(relht ~ value + I(value^2), data=relht_NR_long %>% filter(name=="Eref"))
newdata_NR_relhtEref <- with(relht_NR_long %>% filter(name=="Eref"), data.frame(value=seq(min(value),max(value),length.out=100)))

NR_relhtEref_predict <- predict(NR_relhtEref_quad_lm, newdata = newdata_NR_relhtEref, interval="confidence")

predictdata_NR_relhtEref <- cbind(newdata_NR_relhtEref, NR_relhtEref_predict)

NR_Eref_plot<- ggplot()+
  geom_ribbon(data=predictdata_NR_relhtEref, aes(x=value, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_NR_relhtEref, aes(x=value,y=fit), color="black")+
  xlab("Eref")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_NR_long %>% filter(name=="Eref")%>% mutate(fit=10), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
NR_Eref_plot
```
...
NR_reldbh_mods %>% arrange(pvalue) #many temp variables are significant
...
predictdata_NR_reldbhMAT <- cbind(newdata_NR_reldbhMAT, NR_reldbhMAT_predict)
...
##NFFD
NR_reldbhNFFD <- lmer(sqrt(relDBH) ~ value + (1|Provenance) + (1|BLK) + (1|year), data=NR_dbh_growth_clim_long %>% filter(name=="NFFD"))
plot(NR_reldbhNFFD)
qqmath(NR_reldbhNFFD)
summary(NR_reldbhNFFD)

NR_reldbhNFFD_lm <- lm(sqrt(relDBH) ~ value, data=NR_dbh_growth_clim_long %>% filter(name=="NFFD"))
newdata_NR_reldbhNFFD <- with(NR_dbh_growth_clim_long %>% filter(name=="NFFD"), data.frame(value=seq(min(value),max(value),length.out=100)))

NR_reldbhNFFD_predict <- predict(NR_reldbhNFFD_lm, newdata = newdata_NR_reldbhNFFD, interval="confidence")

predictdata_NR_reldbhNFFD <- cbind(newdata_NR_reldbhNFFD, NR_reldbhNFFD_predict)

NR_NFFD_plot<- ggplot()+
  geom_ribbon(data=predictdata_NR_reldbhNFFD, aes(x=value, ymin=lwr^2, ymax=upr^2), fill="black", alpha=0.2)+
  geom_line(data=predictdata_NR_reldbhNFFD, aes(x=value,y=fit^2), color="black")+
  xlab("NFFD")+
  ylab("Basal Area Growth Rate (cm^2/yr)")+
  geom_rug(data=NR_dbh_growth_clim_long %>% filter(name=="NFFD")%>% mutate(fit=40), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
NR_NFFD_plot
...
NR_reldbh_mods_quad %>% arrange(pvalue2) #PPTwt significant

##PPTwt
NR_reldbhPPTwt <- lmer(sqrt(relDBH) ~ value + I(value^2) + (1|Provenance) + (1|BLK) + (1|year), data=NR_dbh_growth_clim_long %>% filter(name=="PPTwt"))
plot(NR_reldbhPPTwt)
qqmath(NR_reldbhPPTwt)
summary(NR_reldbhPPTwt)

NR_reldbhPPTwt_lm <- lm(sqrt(relDBH) ~ value + I(value^2), data=NR_dbh_growth_clim_long %>% filter(name=="PPTwt"))
newdata_NR_reldbhPPTwt <- with(NR_dbh_growth_clim_long %>% filter(name=="PPTwt"), data.frame(value=seq(min(value),max(value),length.out=100)))

NR_reldbhPPTwt_predict <- predict(NR_reldbhPPTwt_lm, newdata = newdata_NR_reldbhPPTwt, interval="confidence")

predictdata_NR_reldbhPPTwt <- cbind(newdata_NR_reldbhPPTwt, NR_reldbhPPTwt_predict)

NR_PPTwt_plot<- ggplot()+
  geom_ribbon(data=predictdata_NR_reldbhPPTwt, aes(x=value, ymin=lwr^2, ymax=upr^2), fill="black", alpha=0.2)+
  geom_line(data=predictdata_NR_reldbhPPTwt, aes(x=value,y=fit^2), color="black")+
  xlab("PPTwt")+
  ylab("Basal Area Growth Rate (cm^2/yr)")+
  geom_rug(data=NR_dbh_growth_clim_long %>% filter(name=="PPTwt")%>% mutate(fit=40), aes(x=value,y=fit), linewidth=1, col="black", sides="b")+
  theme_bw()
NR_PPTwt_plot
...
dbh_NR_mods %>% arrange(pvalue) ##MAT and many others significant
...
dbh_NR_mods_quad %>% arrange(pvalue2) #MAP and others significant
```
...
y_max_relht_DD0 = coef(transfer_relhtDD0_quad_lm)[1] + coef(transfer_relhtDD0_quad_lm)[2]*x_relht_DD0_quad + coef(transfer_relhtDD0_quad_lm)[3]*(x_relht_DD0_quad^2)

transfer_DD0_plot<- ggplot()+
  geom_ribbon(data=predictdata_transfer_relhtDD0, aes(x=transfer, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_transfer_relhtDD0, aes(x=transfer,y=fit), color="black")+
  xlab("DD0")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_transfer_df %>% filter(name=="DD0")%>% mutate(fit=10), aes(x=transfer,y=fit), linewidth=1, col="black", sides="b")+
  geom_vline(xintercept = x_relht_DD0_quad, col="violet", linewidth=1)+
  theme_bw()
transfer_DD0_plot
...
##PPTsm
transfer_relht_PPTsm_quad <- lmer(relht ~ transfer + I(transfer^2) + (1|Provenance) + (1|BLK) + (1|year), data=relht_transfer_df %>% filter(name=="PPTsm"))
plot(transfer_relht_PPTsm_quad)
qqmath(transfer_relht_PPTsm_quad)
summary(transfer_relht_PPTsm_quad)

transfer_relhtPPTsm_quad_lm <- lm(relht ~  transfer + I(transfer^2) , data=relht_transfer_df %>% filter(name=="PPTsm"))
newdata_transfer_relhtPPTsm <- with(relht_transfer_df %>% filter(name=="PPTsm"), data.frame(transfer=seq(min(transfer),max(transfer),length.out=100)))

transfer_relhtPPTsm_predict <- predict(transfer_relhtPPTsm_quad_lm, newdata = newdata_transfer_relhtPPTsm, interval="confidence")

predictdata_transfer_relhtPPTsm <- cbind(newdata_transfer_relhtPPTsm, transfer_relhtPPTsm_predict)

x_max_relht_PPTsm_quad = -coef(transfer_relhtPPTsm_quad_lm)[2] / (2*coef(transfer_relhtPPTsm_quad_lm)[3])

y_max_relht_PPTsm_quad = coef(transfer_relhtPPTsm_quad_lm)[1] + coef(transfer_relhtPPTsm_quad_lm)[2]*x_max_relht_PPTsm_quad + coef(transfer_relhtPPTsm_quad_lm)[3]*(x_max_relht_PPTsm_quad^2)

transfer_PPTsm_plot<- ggplot()+
  geom_ribbon(data=predictdata_transfer_relhtPPTsm, aes(x=transfer, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_transfer_relhtPPTsm, aes(x=transfer,y=fit), color="black")+
  xlab("PPTsm")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_transfer_df %>% filter(name=="PPTsm")%>% mutate(fit=10), aes(x=transfer,y=fit), linewidth=1, col="black", sides="b")+
  geom_vline(xintercept = x_max_relht_PPTsm_quad, col="violet", linewidth=1)+
  theme_bw()
transfer_PPTsm_plot
y_max_relht_PPTsm_quad
x_max_relht_PPTsm_quad
...
transfer_Eref_plot<- ggplot()+
  geom_ribbon(data=predictdata_transfer_relhtEref, aes(x=transfer, ymin=lwr, ymax=upr), fill="black", alpha=0.2)+
  geom_line(data=predictdata_transfer_relhtEref, aes(x=transfer,y=fit), color="black")+
  xlab("Eref")+
  ylab("Relative Height Growth Rate (%/year)")+
  geom_rug(data=relht_transfer_df %>% filter(name=="Eref")%>% mutate(fit=10), aes(x=transfer,y=fit), linewidth=1, col="black", sides="b")+
  geom_vline(xintercept = x_max_relht_Eref_quad, col="violet", linewidth=1)+
  theme_bw()
transfer_Eref_plot
