...
summary(relht_mwmt_transfermod_nog) #further away from plantation in latitude = taller
...
summary(relht_climdist_mod) #climatically further from the plantation = greater height
