...
for(i in 1:length(provenance_climvars)){
mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ diff_plant + (1|code) + (1|year) + (1|BLK), data=cone_clim_long_transfer %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
p.value<- summary(mod)$coefficients$cond[2,]["Pr(>|z|)"]
Mr2 <- r2(mod)$R2_marginal

mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ diff_plant + (1|code) + (1|year) + (1|BLK), data=cone_clim_long_transfer_nog %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
...
#PPTsm
cone_pptsm_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ diff_plant + (1|year) + (1|code)+(1|BLK), data=cone_clim_long_transfer_nog %>% filter(climvar.name=="PPTsm"), family=binomial)
...
#PPTsp
cone_pptsp_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ diff_plant + (1|year) + (1|code)+(1|BLK), data=cone_clim_long_transfer_nog %>% filter(climvar.name=="PPTsp"), family=binomial)
...
cone_climdist_mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ dist_2d + (1|Provenance) + (1|year) + (1|BLK), data=cone_climdist_df, family=binomial)
...
cone_climdist_mod_20s <- glmmTMB(cbind(n_cones,total-n_cones) ~ dist_2d + (1|Provenance) + (1|year) + (1|BLK), data=cone_climdist_df_2020s, family=binomial)
...
cone_climdist_mod_50s <- glmmTMB(cbind(n_cones,total-n_cones) ~ dist_2d + (1|Provenance) + (1|year) + (1|BLK), data=cone_climdist_df_2050s, family=binomial)
...
cone_climdist_mod_80s <- glmmTMB(cbind(n_cones,total-n_cones) ~ dist_2d + (1|Provenance) + (1|year) + (1|BLK), data=cone_climdist_df_2080s, family=binomial)
