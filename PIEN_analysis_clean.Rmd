...
ggplot(cor_means %>% filter(!time_season=="priorsp") %>% filter(!var=="spei"), aes(x=factor(time_season, levels=c("priorsp","priorsm","priorfa","priorwt","NAsp","NAsm"), labels= c("priorsp","priorsm","priorfa","priorwt","sp","sm")), y=estimate,col=mean.cor>0))+
...
allanovas %>% filter(pvalue<0.05) #prior_ppt_wt, cwd_sp, prior_spei_wt have significant differences between provenances. Not looking at sPEI cause it says same thing as ppt
