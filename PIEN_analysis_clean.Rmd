...
ggplot()+
  geom_ribbon(data=predictdata_lat_ht, aes(x=climvar.value, ymin=lwr, ymax=upr), alpha=0.2)+
  geom_line(data=predictdata_lat_ht, aes(x=climvar.value,y=fit), color="black")+
  geom_rug(data=ht_data_year_clim_long_noG %>% filter(climvar.name=="y") %>% mutate(fit=.8), aes(x=climvar.value,y=fit), linewidth=1, col="black", sides="b")+
  xlab("Provenance Latitude")+
...
ggplot(ht_growth_rel_data %>% filter(value<300), aes(x=factor(Provenance,levels=provs_bylat$Provenance), y=value, fill=factor(Provenance,levels=provs_bylat$Provenance)))+
  geom_boxplot()+
  theme(axis.text.x=element_text(angle=45, hjust=1))+
  ylab("Relative Height Growth Per Year (%)")+ xlab("")+
  scale_fill_manual(values=unname(stepped()), name="Provenance")
...
###individual climate variables
```{r}
moniger_provclim<- cone_data_binom %>% 
...
for(i in 1:length(provenance_climvars)){
mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
pvalue<- summary(mod)$coefficients$cond[2,]["Pr(>|z|)"]
Mr2=r2(mod)$R2_marginal

mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name==provenance_climvars[i]) %>% filter(!code=="GiNF"), family=binomial)
pvalue_nog<- summary(mod_nog)$coefficients$cond[2,]["Pr(>|z|)"]
Mr2_nog=r2(mod_nog)$R2_marginal

cone_mods <- bind_rows(cone_mods, data.frame(var=provenance_climvars[i], pvalue = pvalue, Mr2=Mr2, pvalue_nog = pvalue_nog, Mr2_nog = Mr2_nog))
...
###PPTsm
cone_pptsm_mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(!Provenance=="Gila NF") %>% filter(climvar.name=="PPTsm"), family=binomial)
summary(cone_pptsm_mod)
r2(cone_pptsm_mod)
...
r2(cone_smrpb_mod_nog)

cone_smrpb_data_nog <- moniger_provclim %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF")

#prediction
##take random effect out to make predictions
cone_smrpb_mod_nog_glm <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value, data=cone_smrpb_data_nog, family=binomial)
...
for(i in 1:length(provenance_climvars)){
mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ scale(climvar.value)*height + I(scale(climvar.value)^2) + (1|code) + (1|year) + (1|BLK), data=moniger_provclim %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
pvalues<- as.data.frame(summary(mod)$coefficients$cond[2:3,])$`Pr(>|z|)`
Mr2 <- r2(mod)$R2_marginal

mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ scale(climvar.value)*height + I(scale(climvar.value)^2) + (1|code) + (1|year) + (1|BLK), data=moniger_provclim %>% filter(climvar.name==provenance_climvars[i]) %>% filter(!code=="GiNF"), family=binomial)
...
###PPTsm
cone_ht_pptsm_mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name=="PPTsm"), family=binomial)
summary(cone_ht_pptsm_mod)
r2(cone_ht_pptsm_mod)

cone_ht_pptsm_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(!Provenance=="Gila NF") %>% filter(climvar.name=="PPTsm"), family=binomial)
summary(cone_ht_pptsm_mod_nog)
r2(cone_ht_pptsm_mod_nog)

cone_ht_pptsm_data_nog <- moniger_provclim %>% filter(!Provenance=="Gila NF") %>% filter(climvar.name=="PPTsm")
...
##predictions - 3.9m
cone_ht_pptsm_nog_newdata1 <- with(cone_ht_pptsm_data_nog, data.frame(climvar.value = seq(min(climvar.value),max(climvar.value),length.out=50), height=3.9))
...
ggplot(cone_ht_pptsm_nog_newdata3, aes(x = climvar.value, y = PredictedProb)) + 
  ...
  geom_rug(data=moniger_provclim %>% filter(climvar.name=="PPTsm") %>% mutate(PredictedProb=0.6), sides="b", linewidth=1, color="black", alpha=0.5)+
  scale_linetype_manual(values=c(2,1))+
  scale_fill_manual(values=c("darkgray","black"))+
  ylim(c(0,1))+
...
###TD
cone_ht_TD_mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name=="TD"), family=binomial)
summary(cone_ht_TD_mod) 
r2(cone_ht_TD_mod)

cone_ht_TD_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name=="TD") %>% filter(!Provenance=="Gila NF"), family=binomial)
summary(cone_ht_TD_mod_nog) 
r2(cone_ht_TD_mod_nog)

cone_ht_td_data_nog<- moniger_provclim %>% filter(climvar.name=="TD") %>% filter(!Provenance=="Gila NF")
...
ggplot() + 
  ...
  geom_rug(data=moniger_provclim %>% filter(climvar.name=="TD") %>% mutate(PredictedProb=0.6) %>% dplyr::select(-height), aes(x=climvar.value), sides="b", linewidth=1, color="black", alpha=0.5)+
  ylim(c(0,1))+
  xlab("Provenance TD")+
  ylab("Predicted Probability of Cones")+
  theme_bw()
...
###DD5
cone_ht_DD5_mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ climvar.value*height + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name=="DD5"), family=binomial)
summary(cone_ht_DD5_mod) 
r2(cone_ht_DD5_mod)

cone_ht_dd5_data<- moniger_provclim %>% filter(climvar.name=="DD5") 
...
ggplot() + 
  ...
  geom_rug(data=moniger_provclim %>% filter(climvar.name=="DD5") %>% mutate(PredictedProb=0.6) %>% dplyr::select(-height), aes(x=climvar.value), sides="b", linewidth=1, color="black", alpha=0.5)+
  ylim(c(0,1))+
  xlab("Provenance DD5")+
  ylab("Predicted Probability of Cones")+
  theme_bw()
...
###PPTsm
cone_ht_pptsm_quad_mod <- glmmTMB(cbind(n_cones,total-n_cones) ~ scale(climvar.value)*height + I(scale(climvar.value)^2) + (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(climvar.name=="PPTsm"), family=binomial)
summary(cone_ht_pptsm_quad_mod)
r2(cone_ht_pptsm_quad_mod)

cone_ht_pptsm_quad_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~  scale(climvar.value)*height + I(scale(climvar.value)^2)+ (1|year) + (1|code) + (1|BLK), data=moniger_provclim %>% filter(!Provenance=="Gila NF") %>% filter(climvar.name=="PPTsm"), family=binomial)
...
cone_clim_long_transfer <- moniger_provclim %>%
  left_join(plantation_climNA, by=c("climvar.name"="var")) %>% 
  mutate(diff_plant = abs(plant_value - climvar.value))
...
cone_mods_transfer %>% arrange(p.value_nog) #PPTsm and PPTsp
cone_mods_transfer %>% filter(p.value_nog<0.05) %>% arrange(Mr2_nog) 

#PPTsm
cone_pptsm_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ diff_plant*height + (1|year) + (1|code)+(1|BLK), data=cone_clim_long_transfer_nog %>% filter(climvar.name=="PPTsm"), family=binomial)
summary(cone_pptsm_mod_nog) #provenances with summer precip more different from the plantation have higher likelihood of cones.
r2(cone_pptsm_mod_nog)

#PPTsp
cone_pptsp_mod_nog <- glmmTMB(cbind(n_cones,total-n_cones) ~ diff_plant*height + (1|year) + (1|code)+(1|BLK), data=cone_clim_long_transfer_nog %>% filter(climvar.name=="PPTsp"), family=binomial)
summary(cone_pptsp_mod_nog) #provenances with spring precip more similar to the plantation have higher probability of cones. 
r2(cone_pptsp_mod_nog)
...
cone_climdist_df_2020s <- moniger_provclim %>%
...
cone_climdist_df_2050s <- moniger_provclim %>%
...
cone_climdist_df_2080s <- moniger_provclim %>%
...
alive_blk_yr <- moniger_survival_byyr %>% 
  ...
  mutate(prev.yr = case_when(year == 1974 ~ 1970,
                             ...
                             year == 2006 ~ 1996,
                             year == 2014 ~ 2006)) %>% 
  mutate(prev.yr.alive = ifelse(prev.yr==1970, 4, alive))

moniger_survival_byyr_binom<- moniger_survival_byyr %>% 
  group_by(Provenance,BLK,year) %>% 
  summarise(alive=sum(value)) %>% 
  left_join(alive_blk_yr) %>% 
  mutate(died=prev.yr.alive-alive) %>% 
...
survmod_byyear<- glmmTMB(cbind(alive, died) ~ factor(year)*Provenance, data=moniger_survival_byyr_binom, family=binomial)
summary(survmod_byyear)
...
confint(survmod79)
survmod79_marg = lsmeans(survmod79, ~ Provenance)

CLD_survmod79 = cld(survmod79_marg,
          alpha=0.05,
          Letters=letters)
CLD_survmod79 
...
confint(survmod85)
survmod85_marg = lsmeans(survmod85, ~ Provenance)

CLD_survmod85 = cld(survmod85_marg,
          alpha=0.05,
          Letters=letters)
CLD_survmod85 
...
confint(survmod91)
survmod91_marg = lsmeans(survmod91, ~ Provenance)

CLD_survmod91 = cld(survmod91_marg,
          alpha=0.05,
          Letters=letters)
CLD_survmod91 
...
confint(survmod96)
survmod96_marg = lsmeans(survmod96, ~ Provenance)

CLD_survmod96 = cld(survmod96_marg,
          alpha=0.05,
          Letters=letters)
CLD_survmod96 


survmod06 <- glmmTMB(cbind(alive, died) ~ Provenance + (1|BLK), data=moniger_survival_byyr_binom %>% filter(year==2006), family=binomial) ###this doesn't converge probably because of few deaths
Anova(survmod06, type="3")
confint(survmod06)
survmod06_marg = lsmeans(survmod06, ~ Provenance)

CLD_survmod06 = cld(survmod06_marg,
          alpha=0.05,
          Letters=letters)
CLD_survmod06 
...
confint(survmod14)
survmod14_marg = lsmeans(survmod14, ~ Provenance)

CLD_survmod14 = cld(survmod14_marg,
          alpha=0.05,
          Letters=letters)
CLD_survmod14 
...
cor(moniger_survival_byyr_binom$smrpb,moniger_survival_byyr_binom$PPTsp) #not super correlated so I'll look at them separately
...
#PPTsp
surv_PPTsp_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="PPTsp"), family="binomial")
summary(surv_PPTsp_mod)

surv_PPTsp_data <- moniger_survival_long %>% filter(climvar.name=="PPTsp")

newdata_PPTsp_surv <- data.frame(
    climvar.value = seq(min(surv_PPTsp_data$climvar.value), 
                      max(surv_PPTsp_data$climvar.value), 
                      length.out = 100
                      ))

##predictions
survPPTsp_newdata1 <-  expand.grid(climvar.value = seq(min(newdata_PPTsp_surv$climvar.value),max(newdata_PPTsp_surv$climvar.value),length.out=50))

surv_PPTsp_mod_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value), data=moniger_survival_long %>% filter(climvar.name=="PPTsp"), family="binomial")

survPPTsp_newdata2 <- cbind(survPPTsp_newdata1, predict(surv_PPTsp_mod_glm, newdata = survPPTsp_newdata1, type = "link", se=TRUE))
survPPTsp_newdata3 <- within(survPPTsp_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})

ggplot(survPPTsp_newdata3, aes(x = climvar.value, y = PredictedProb)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("PPTsp")

#without Gila is still significant
surv_PPTsp_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+(1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="PPTsp") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_PPTsp_mod_nog)

##predictions
surv_PPTsp_data_nog <- moniger_survival_long %>% filter(climvar.name=="PPTsp") %>% filter(!Provenance=="Gila NF")

survPPTsp_nog_newdata1 <- expand.grid(climvar.value = seq(min(surv_PPTsp_data_nog$climvar.value),max(surv_PPTsp_data_nog$climvar.value),length.out=50))

surv_PPTsp_mod_nog_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value), data=moniger_survival_long %>% filter(climvar.name=="PPTsp") %>% filter(!Provenance=="Gila NF"), family="binomial")


survPPTsp_nog_newdata2 <- cbind(survPPTsp_nog_newdata1, predict(surv_PPTsp_mod_nog_glm, newdata = survPPTsp_nog_newdata1, type = "link", se=TRUE))
survPPTsp_nog_newdata3 <- within(survPPTsp_nog_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})

survPPTsp_bothmod_data<- bind_rows(survPPTsp_newdata3 %>% mutate(model="with Gila NF"),
survPPTsp_nog_newdata3 %>% mutate(model="without Gila NF"))

ggplot(survPPTsp_bothmod_data, aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("PPTsp")
#########
...
surv_mods_quad %>% arrange(pvalue2_nog) ##Eref, lat, smrpb
##Eref
...
##smrpb
surv_smrpb_mod2 <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="smrpb"), family="binomial")
summary(surv_smrpb_mod2)
r2(surv_smrpb_mod2)

surv_smrpb_mod2_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_long %>% filter(climvar.name=="smrpb"), family="binomial")

##predictions
survsmrpb2_newdata1 <- expand.grid(climvar.value = seq(min(surv_smrpb_data$climvar.value),max(surv_smrpb_data$climvar.value),length.out=50))

survsmrpb2_newdata2 <- cbind(survsmrpb2_newdata1, predict(surv_smrpb_mod2_glm, newdata = survsmrpb2_newdata1, type = "link", se=TRUE))
survsmrpb2_newdata3 <- within(survsmrpb2_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})
...
#without Gila is still significant
surv_smrpb_mod2_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_smrpb_mod2_nog)
r2(surv_smrpb_mod2_nog)

surv_smrpb_mod2_nog_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_long %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF"), family="binomial")

##predictions
survsmrpb2_newdata1_nog <- expand.grid(climvar.value = seq(min(moniger_survival_long %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),max(moniger_survival_long %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),length.out=50))

survsmrpb2_newdata2_nog <- cbind(survsmrpb2_newdata1_nog, predict(surv_smrpb_mod2_nog_glm, newdata = survsmrpb2_newdata1_nog, type = "link", se=TRUE))
survsmrpb2_newdata3_nog <- within(survsmrpb2_newdata2_nog, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})

surv_smrpb_bothmod <- bind_rows(survsmrpb2_newdata3 %>% mutate(model="with Gila NF"),survsmrpb2_newdata3_nog %>% mutate(model="without Gila NF"))

ggplot(surv_smrpb_bothmod, aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("smrpb")+
    ylab("Predicted Probability")+
...
ggplot(survsmrpb2_newdata3_nog %>% mutate(model="without Gila NF"), aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("smrpb")+
    ylab("Predicted Probability")+
...
##y
surv_y_mod2 <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="y"), family="binomial")
summary(surv_y_mod2)
r2(surv_y_mod2)

surv_y_mod2_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_long %>% filter(climvar.name=="y"), family="binomial")

surv_y_data <- moniger_survival_long %>% filter(climvar.name=="y")

##predictions
survy2_newdata1 <- expand.grid(climvar.value = seq(min(surv_y_data$climvar.value),max(surv_y_data$climvar.value),length.out=50))

survy2_newdata2 <- cbind(survy2_newdata1, predict(surv_y_mod2_glm, newdata = survy2_newdata1, type = "link", se=TRUE))
survy2_newdata3 <- within(survy2_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})
...
#without Gila is still significant
surv_y_mod2_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_y_mod2_nog)
r2(surv_y_mod2_nog)

surv_y_mod2_nog_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF"), family="binomial")

##predictions

survy2_newdata1_nog <- expand.grid(climvar.value = seq(min(moniger_survival_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),max(moniger_survival_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),length.out=50))

survy2_newdata2_nog <- cbind(survy2_newdata1_nog, predict(surv_y_mod2_nog_glm, newdata = survy2_newdata1_nog, type = "link", se=TRUE))
survy2_newdata3_nog <- within(survy2_newdata2_nog, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})

surv_y_bothmod <- bind_rows(survy2_newdata3 %>% mutate(model="with Gila NF"),survy2_newdata3_nog %>% mutate(model="without Gila NF"))

ggplot(surv_y_bothmod, aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("y")+
    ylab("Predicted Probability")+
...
surv_mods_transfer %>% arrange(p.value_nog) #Eref, RH, y, bFFP, CMD
...
```{r}
### do survival analyses without eliminating trees that didn't survive in the next year's survival numbers. So, this is taking more of a year by year approach, asking how was survival to 1979? to 1985? to 1991? etc. 
...
survmod_byyear_alltrees<- glmmTMB(cbind(alive, died) ~ factor(year)*Provenance, data=moniger_survival_byyr_binom_zeros, family=binomial) 
summary(survmod_byyear_alltrees)
Anova(survmod_byyear, type="3")
...
alltree_survmod06 <- glmmTMB(cbind(alive, died) ~ Provenance + (1|BLK), data=moniger_survival_byyr_binom_zeros %>% filter(year==2006), family=binomial) ###this doesn't converge probably because of few deaths
...
##with gila
alltree_survmod_pc<- glmmTMB(cbind(alive,died) ~  PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_byyr_binom_zeros, family=binomial) 
summary(alltree_survmod_pc)
# 
# dredge_alltree_survmod_pc <- dredge(alltree_survmod_pc)
# dredge_alltree_survmod_pc ##null is best

moniger_survival_alltree_nog <- moniger_survival_byyr_binom_zeros %>% filter(!Provenance%in%c("Gila NF"))

##no gila
alltree_survmod_pc_nog<- glmmTMB(cbind(alive,died) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_nog, family=binomial)

summary(alltree_survmod_pc_nog)
# dredge_alltree_survmod_pc_nog <- dredge(alltree_survmod_pc_nog)
# dredge_alltree_survmod_pc_nog ##null is best
```

###individual climate variables

```{r}
moniger_survival_alltree_long <- moniger_survival_byyr_binom_zeros %>% 
  pivot_longer(c(PC1,PC2,AHM:SHM, x:monsoonality), names_to="climvar.name", values_to = "climvar.value")

surv_mods_alltree<- data.frame()

for(i in 1:length(provenance_climvars)){
mod <- glmmTMB(cbind(alive,died) ~ climvar.value + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
pvalue<- as.data.frame(summary(mod)$coefficients$cond)[2,]$`Pr(>|z|)`
Mr2=r2(mod)$R2_marginal

mod_nog <- glmmTMB(cbind(alive,died) ~ climvar.value + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name==provenance_climvars[i]) %>% filter(!Provenance=="Gila NF"), family=binomial)
pvalue_nog<- as.data.frame(summary(mod_nog)$coefficients$cond)[2,]$`Pr(>|z|)`
Mr2_nog=r2(mod_nog)$R2_marginal


surv_mods_alltree <- bind_rows(surv_mods_alltree, data.frame(var=provenance_climvars[i], pvalue = pvalue, Mr2=Mr2, pvalue_nog = pvalue_nog, Mr2_nog = Mr2_nog))}

surv_mods_alltree %>% arrange(pvalue_nog) ##length of growing season seems to be influential both with and without Gila, also smrpb
surv_mods_alltree %>% 
  filter(pvalue_nog<0.05) %>% 
  arrange(desc(Mr2_nog))

#eFFP
surv_alltreeeFFP_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="eFFP"), family="binomial")
summary(surv_alltreeeFFP_mod)

surv_alltreeeFFP_data <- moniger_survival_alltree_long %>% filter(climvar.name=="eFFP")

newdata_eFFP_surv <- data.frame(
    climvar.value = seq(min(surv_alltreeeFFP_data$climvar.value), 
                      max(surv_alltreeeFFP_data$climvar.value), 
                      length.out = 100
                      ))

##predictions
surveFFP_newdata1 <-  expand.grid(climvar.value = seq(min(newdata_eFFP_surv$climvar.value),max(newdata_eFFP_surv$climvar.value),length.out=50))

surv_alltreeeFFP_mod_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value), data=moniger_survival_alltree_long %>% filter(climvar.name=="eFFP"), family="binomial")

surveFFP_newdata2 <- cbind(surveFFP_newdata1, predict(surv_alltreeeFFP_mod_glm, newdata = surveFFP_newdata1, type = "link", se=TRUE))
...
#without Gila is still significant
surv_alltreeeFFP_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+(1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="eFFP") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_alltreeeFFP_mod_nog)

surv_alltreeeFFP_mod_nog_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value), data=moniger_survival_alltree_long %>% filter(climvar.name=="eFFP") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_alltreeeFFP_mod_nog)

##predictions
surv_alltreeeFFP_data_nog <- moniger_survival_alltree_long %>% filter(climvar.name=="eFFP") %>% filter(!Provenance=="Gila NF")

surveFFP_nog_newdata1 <- expand.grid(climvar.value = seq(min(surv_alltreeeFFP_data_nog$climvar.value),max(surv_alltreeeFFP_data_nog$climvar.value),length.out=50))

surveFFP_nog_newdata2 <- cbind(surveFFP_nog_newdata1, predict(surv_alltreeeFFP_mod_nog_glm, newdata = surveFFP_nog_newdata1, type = "link", se=TRUE))
surveFFP_nog_newdata3 <- within(surveFFP_nog_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})

surveFFP_bothmod_data<- bind_rows(surveFFP_newdata3 %>% mutate(model="with Gila NF"),
surveFFP_nog_newdata3 %>% mutate(model="without Gila NF"))

ggplot(surveFFP_bothmod_data, aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("eFFP")
#########
...
#smrpb
surv_alltreesmrpb_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+ (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="smrpb"), family="binomial")
summary(surv_alltreesmrpb_mod)

surv_alltreesmrpb_data <- moniger_survival_alltree_long %>% filter(climvar.name=="smrpb")

newdata_smrpb_surv <- data.frame(
    climvar.value = seq(min(surv_alltreesmrpb_data$climvar.value), 
                      max(surv_alltreesmrpb_data$climvar.value), 
                      length.out = 100
                      ))
...
surv_alltreesmrpb_mod_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value), data=moniger_survival_alltree_long %>% filter(climvar.name=="smrpb"), family="binomial")

survsmrpb_newdata2 <- cbind(survsmrpb_newdata1, predict(surv_alltreesmrpb_mod_glm, newdata = survsmrpb_newdata1, type = "link", se=TRUE))
survsmrpb_newdata3 <- within(survsmrpb_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
...
#without Gila is still significant
surv_alltreesmrpb_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + (1|Provenance)+(1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_alltreesmrpb_mod_nog)

##predictions
surv_alltreesmrpb_data_nog <- moniger_survival_alltree_long %>% filter(climvar.name=="smrpb") %>% filter(!Provenance=="Gila NF")

survsmrpb_nog_newdata1 <- expand.grid(climvar.value = seq(min(surv_alltreesmrpb_data_nog$climvar.value),max(surv_alltreesmrpb_data_nog$climvar.value),length.out=50),
                                 Provenance = "Pike NF",
                                 BLK = "C",
                                 year=2006)

survsmrpb_nog_newdata2 <- cbind(survsmrpb_nog_newdata1, predict(surv_alltreesmrpb_mod_nog, newdata = survsmrpb_nog_newdata1, type = "link", se=TRUE))
survsmrpb_nog_newdata3 <- within(survsmrpb_nog_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
...
surv_alltreemods_quad<- data.frame()

for(i in 1:length(provenance_climvars)){
mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name==provenance_climvars[i]), family="binomial")
pvalues<- as.data.frame(summary(mod)$coefficients$cond)[2:3,]$`Pr(>|z|)`
Mr2 <- r2(mod)$R2_marginal

mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name==provenance_climvars[i]) %>% filter(!Provenance=="Gila NF"), family="binomial")
pvalues_nog<- as.data.frame(summary(mod_nog)$coefficients$cond)[2:3,]$`Pr(>|z|)`
Mr2_nog <- r2(mod_nog)$R2_marginal

surv_alltreemods_quad <- bind_rows(surv_alltreemods_quad, data.frame(var=provenance_climvars[i], pvalue1 = pvalues[1], pvalue2 = pvalues[2], Mr2 = Mr2, pvalue1_nog = pvalues_nog[1], pvalue2_nog = pvalues_nog[2], Mr2_nog = Mr2_nog))

}

surv_alltreemods_quad %>% arrange(pvalue2_nog) ##Eref and CMD are significant both with and without Gila, but they are positively correlated so I will just use Eref since it has a larger r2.

##Eref
surv_alltreeEref_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="Eref"), family="binomial")
summary(surv_alltreeEref_mod)
r2(surv_alltreeEref_mod)

surv_alltreeEref_mod_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_alltree_long %>% filter(climvar.name=="Eref"), family="binomial")

surv_alltreeEref_data <- moniger_survival_alltree_long %>% filter(climvar.name=="Eref")

##predictions
survEref_newdata1 <- expand.grid(climvar.value = seq(min(surv_alltreeEref_data$climvar.value),max(surv_alltreeEref_data$climvar.value),length.out=50))

survEref_newdata2 <- cbind(survEref_newdata1, predict(surv_alltreeEref_mod_glm, newdata = survEref_newdata1, type = "link", se=TRUE))
survEref_newdata3 <- within(survEref_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
...
#without Gila is still significant
surv_alltreeeref_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="Eref") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_alltreeeref_mod_nog)
r2(surv_alltreeeref_mod_nog)

surv_alltreeeref_mod_nog_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_alltree_long %>% filter(climvar.name=="Eref") %>% filter(!Provenance=="Gila NF"), family="binomial")

##predictions
surveref_newdata1_nog <- expand.grid(climvar.value = seq(min(moniger_survival_alltree_long %>% filter(climvar.name=="Eref") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),max(moniger_survival_alltree_long %>% filter(climvar.name=="Eref") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),length.out=50))

surveref_newdata2_nog <- cbind(surveref_newdata1_nog, predict(surv_alltreeeref_mod_nog_glm, newdata = surveref_newdata1_nog, type = "link", se=TRUE))
surveref_newdata3_nog <- within(surveref_newdata2_nog, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
...
surv_alltreeeref_bothmod <- bind_rows(survEref_newdata3 %>% mutate(model="with Gila NF"),surveref_newdata3_nog %>% mutate(model="without Gila NF"))

ggplot(surv_alltreeeref_bothmod, aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("Eref")+
    ylab("Predicted Probability")+
...
##y
surv_alltreey_mod <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="y"), family="binomial")
summary(surv_alltreey_mod)
r2(surv_alltreey_mod)

surv_alltreey_mod_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_alltree_long %>% filter(climvar.name=="y"), family="binomial")

surv_alltreey_data <- moniger_survival_alltree_long %>% filter(climvar.name=="y")

##predictions
survy_alltree_newdata1 <- expand.grid(climvar.value = seq(min(surv_alltreey_data$climvar.value),max(surv_alltreey_data$climvar.value),length.out=50))

survy_alltree_newdata2 <- cbind(survy_alltree_newdata1, predict(surv_alltreey_mod_glm, newdata = survy_alltree_newdata1, type = "link", se=TRUE))
survy_alltree_newdata3 <- within(survy_alltree_newdata2, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})
...
#without Gila is still significant
surv_y_alltree_mod_nog <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2) + (1|Provenance) + (1|BLK) + (1|year), data=moniger_survival_alltree_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF"), family="binomial")
summary(surv_y_alltree_mod_nog)
r2(surv_y_alltree_mod_nog)

surv_y_alltree_mod_nog_glm <- glmmTMB(cbind(alive,died) ~ scale(climvar.value) + I(scale(climvar.value)^2), data=moniger_survival_alltree_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF"), family="binomial")

##predictions
survy_alltree_newdata1_nog <- expand.grid(climvar.value = seq(min(moniger_survival_alltree_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),max(moniger_survival_alltree_long %>% filter(climvar.name=="y") %>% filter(!Provenance=="Gila NF") %>% pull(climvar.value)),length.out=50))

survy_alltree_newdata2_nog <- cbind(survy_alltree_newdata1_nog, predict(surv_y_alltree_mod_nog_glm, newdata = survy_alltree_newdata1_nog, type = "link", se=TRUE))
survy_alltree_newdata3_nog <- within(survy_alltree_newdata2_nog, {
    PredictedProb <- plogis(fit)
    LL <- plogis(fit - (1.96 * se.fit))
    UL <- plogis(fit + (1.96 * se.fit))
})

survy_alltree_bothmod <- bind_rows(survy_alltree_newdata3 %>% mutate(model="with Gila NF"),survy_alltree_newdata3_nog %>% mutate(model="without Gila NF"))

ggplot(survy_alltree_bothmod, aes(x = climvar.value, y = PredictedProb, linetype=model)) + geom_ribbon(aes(ymin = LL,
    ymax = UL), alpha = 0.2) + 
  geom_line(linewidth = 1)+
  xlab("y")+
    ylab("Predicted Probability")+
...
surv0_clim_long_transfer <- moniger_survival_alltree_long %>%
  left_join(plantation_climNA, by=c("climvar.name"="var")) %>% 
  mutate(diff_plant = abs(plant_value - climvar.value))

surv0_clim_long_transfer_nog <- surv0_clim_long_transfer %>% filter(!Provenance=="Gila NF")

surv0_mods_transfer<- data.frame()
for(i in 1:length(provenance_climvars)){
mod <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|Provenance) + (1|year) + (1|BLK), data=surv0_clim_long_transfer %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
p.value<- summary(mod)$coefficients$cond[2,]["Pr(>|z|)"]
Mr2 <- r2(mod)$R2_marginal

mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|Provenance) + (1|year) + (1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name==provenance_climvars[i]), family=binomial)
p.value_nog<- summary(mod_nog)$coefficients$cond[2,]["Pr(>|z|)"]
Mr2_nog <- r2(mod_nog)$R2_marginal

surv0_mods_transfer <- bind_rows(surv0_mods_transfer, data.frame(var=provenance_climvars[i], p.value = p.value, Mr2=Mr2, p.value_nog = p.value_nog, Mr2_nog=Mr2_nog))

}

surv0_mods_transfer %>% arrange(p.value_nog) #Eref, RH, y, bFFP, CMD (all same as other survival metric) + FFP, eFFP
surv0_mods_transfer %>% filter(p.value_nog<0.05) %>% arrange(Mr2_nog) 

#Eref
surv0_Eref_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="Eref"), family=binomial)
summary(surv0_Eref_mod_nog) #provenances with Eref more similar to plantation had higher survival
r2(surv0_Eref_mod_nog)

#CMD
surv0_CMD_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="CMD"), family=binomial)
summary(surv0_CMD_mod_nog) #provenances with CMD more similar to the plantation have higher probability of survival
r2(surv0_CMD_mod_nog)

#FFP
surv0_FFP_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="FFP"), family=binomial)
summary(surv0_FFP_mod_nog) #provenances with FFP more similar to the plantation have higher probability of survival
r2(surv0_FFP_mod_nog)

#bFFP
surv0_bFFP_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="bFFP"), family=binomial)
summary(surv0_bFFP_mod_nog) #provenances with bFFP more similar to the plantation have higher probability of survival
r2(surv0_bFFP_mod_nog)

#eFFP
surv0_eFFP_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="eFFP"), family=binomial)
summary(surv0_eFFP_mod_nog) #provenances with eFFP more similar to the plantation have higher probability of survival
r2(surv0_eFFP_mod_nog)

#RH
surv0_RH_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="RH"), family=binomial)
summary(surv0_RH_mod_nog) #provenances with RH more similar to the plantation have higher probability of survival
r2(surv0_RH_mod_nog)

#y
surv0_y_mod_nog <- glmmTMB(cbind(alive,died) ~ diff_plant + (1|year) + (1|Provenance)+(1|BLK), data=surv0_clim_long_transfer_nog %>% filter(climvar.name=="y"), family=binomial)
summary(surv0_y_mod_nog) #provenances with y more similar to the plantation have higher probability of survival
r2(surv0_y_mod_nog)

##distance in 2d climate space

surv0_climdist_df <- surv0_clim_long_transfer %>% 
  dplyr::select(Provenance, BLK, year, alive, died, climvar.name, diff_plant) %>% 
  filter(climvar.name %in% c("PC1","PC2")) %>% 
  pivot_wider(names_from=climvar.name,values_from = diff_plant) %>% 
  mutate(dist_2d = sqrt(PC1^2 + PC2^2))
  
surv0_climdist_mod <- glmmTMB(cbind(alive,died) ~ dist_2d + (1|Provenance) + (1|year) + (1|BLK), data=surv0_climdist_df, family=binomial)
summary(surv0_climdist_mod) # not significant 
...
##PCA models
resis_0203mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0203_clim)
plot(resis_0203mod_pc)
qqmath(resis_0203mod_pc)
summary(resis_0203mod_pc) 

resis_0203mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0203_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_0203mod_pc_noG)
qqmath(resis_0203mod_pc_noG)
summary(resis_0203mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_0203mod_pc) ##null model is the best
```
...
##PCA models
resis_0003mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0003_clim)
plot(resis_0003mod_pc)
qqmath(resis_0003mod_pc)
summary(resis_0003mod_pc) 

resis_0003mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0003_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_0003mod_pc_noG)
qqmath(resis_0003mod_pc_noG)
summary(resis_0003mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_0003mod_pc) ##null model is the best
```
...
##PCA models
resis_0005mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0005_clim)
plot(resis_0005mod_pc)
qqmath(resis_0005mod_pc)
summary(resis_0005mod_pc) 

resis_0005mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0005_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_0005mod_pc_noG)
qqmath(resis_0005mod_pc_noG)
summary(resis_0005mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_0005mod_pc) ##null model is the best
```
...
##PCA models
resis_9904mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR9904_clim)
plot(resis_9904mod_pc)
qqmath(resis_9904mod_pc)
summary(resis_9904mod_pc) 

resis_9904mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR9904_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_9904mod_pc_noG)
qqmath(resis_9904mod_pc_noG)
summary(resis_9904mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_9904mod_pc) ##null model is the best
```
...
##PCA models
resis_1mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR1_clim)
plot(resis_1mod_pc)
qqmath(resis_1mod_pc)
summary(resis_1mod_pc) 

resis_1mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR1_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_1mod_pc_noG)
qqmath(resis_1mod_pc_noG)
summary(resis_1mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_1mod_pc) ##null model is the best
```
...
##PCA models
resis_5mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR5_clim)
plot(resis_5mod_pc)
qqmath(resis_5mod_pc)
summary(resis_5mod_pc) 

resis_5mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR5_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_5mod_pc_noG)
qqmath(resis_5mod_pc_noG)
summary(resis_5mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_5mod_pc) ##null model is the best
```
...
##PCA models
resis_7mod_pc <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR7_clim)
plot(resis_7mod_pc)
qqmath(resis_7mod_pc)
summary(resis_7mod_pc) 

resis_7mod_pc_noG <- lmer(log(resistance) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR7_clim %>% filter(!Provenance=="Gila NF"))
plot(resis_7mod_pc_noG)
qqmath(resis_7mod_pc_noG)
summary(resis_7mod_pc_noG) #nothing significant when Gila removed

#dredge(resis_7mod_pc) ##null model is the best
```
...
#####01-02
##PCA models
resil_0102mod_pc <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0102_clim)
plot(resil_0102mod_pc)
qqmath(resil_0102mod_pc)
summary(resil_0102mod_pc) 

RR0102_clim_nog <- RR0102_clim %>% filter(!Provenance=="Gila NF")

resil_0102mod_pc_noG <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0102_clim_nog)
plot(resil_0102mod_pc_noG)
qqmath(resil_0102mod_pc_noG)
summary(resil_0102mod_pc_noG) #nothing significant when Gila removed

# dredge(resil_0102mod_pc) ##null model is the best
# dredge(resil_0102mod_pc_noG) ##null model is the best
```

```{r}
#####02-03
##PCA models
resil_0203mod_pc <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0203_clim)
plot(resil_0203mod_pc)
qqmath(resil_0203mod_pc)
summary(resil_0203mod_pc) 

resil_0203mod_pc_noG <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR0203_clim %>% filter(!Provenance=="Gila NF"))
plot(resil_0203mod_pc_noG)
qqmath(resil_0203mod_pc_noG)
summary(resil_0203mod_pc_noG) #nothing significant when Gila removed

# dredge(resil_0203mod_pc) ##null model is the best
```
...
#####1 year
##PCA models
resil_1mod_pc <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR1_clim)
plot(resil_1mod_pc)
qqmath(resil_1mod_pc)
summary(resil_1mod_pc) 

resil_1mod_pc_noG <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR1_clim %>% filter(!Provenance=="Gila NF"))
plot(resil_1mod_pc_noG)
qqmath(resil_1mod_pc_noG)
summary(resil_1mod_pc_noG) #nothing significant 

# dredge(resil_1mod_pc) ##null model is the best
```
...
```{r}
#####7 year
RR7_clim_resil <- RR7_clim %>% 
  filter(!is.na(resilience))
##PCA models
resil_7mod_pc <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR7_clim_resil)
plot(resil_7mod_pc)
qqmath(resil_7mod_pc)
summary(resil_7mod_pc) 

resil_7mod_pc_noG <- lmer(log(resilience) ~ PC1*PC2 + I(PC1^2) + I(PC2^2) + (1|Provenance) + (1|BLK), data=RR7_clim_resil %>% filter(!Provenance=="Gila NF"))
plot(resil_7mod_pc_noG)
qqmath(resil_7mod_pc_noG)
summary(resil_7mod_pc_noG) #nothing significant 

# dredge(resil_7mod_pc) ##null model is the best
```
...
new_aov_resist03 <- lmer(resistance ~ Provenance + (1|BLK), data=new_calcs03)
plot(new_aov_resist03)
qqmath(new_aov_resist03)
anova(new_aov_resist03) #no difference in resistance in 2003 when compared to average growth 1985-2002
```
...
for(i in 1:length(climvars)){
  for(j in 1:length(names)){
    ...
    if(!is.na(Cr2.lmer)) (
lmerdata <- bind_rows(lmerdata, data.frame(climvar=climvars[i], name=names[j], pvalue.lmer = pvalue.lmer, r2.lmer=Cr2.lmer, r2type="C")) ) 

    if(is.na(Cr2.lmer)) (
lmerdata <- bind_rows(lmerdata, data.frame(climvar=climvars[i], name=names[j], pvalue.lmer = pvalue.lmer, r2.lmer=Mr2.lmer, r2type="M"))
 ) 
  }}
...
for(i in 1:length(annual_climvar)){
    ...
    Cr2.lmer <- performance::r2(mod)$R2_conditional
    Mr2.lmer <- performance::r2(mod)$R2_marginal
    Cr2.lmer_nog <- performance::r2(mod_nog)$R2_conditional
    Mr2.lmer_nog <- performance::r2(mod_nog)$R2_marginal

    if(!is.na(Cr2.lmer) & !is.na(Cr2.lmer_nog)) (
       correlation_strength_results <- bind_rows(correlation_strength_results, data.frame(annual_climvar = annual_climvar[i], prov_climvar = prov_climvar[i], pvalue_all = as.data.frame(summary(mod)$coefficients)[2,] %>% pull(`Pr(>|t|)`), pvalue_nog = as.data.frame(summary(mod_nog)$coefficients)[2,] %>% pull(`Pr(>|t|)`), r2.lmer=Cr2.lmer, r2type="C", r2.lmer_nog=Cr2.lmer_nog, r2nogtype="C"))
    )
    
        if(is.na(Cr2.lmer) & is.na(Cr2.lmer_nog)) (
       correlation_strength_results <- bind_rows(correlation_strength_results, data.frame(annual_climvar = annual_climvar[i], prov_climvar = prov_climvar[i], pvalue_all = as.data.frame(summary(mod)$coefficients)[2,] %>% pull(`Pr(>|t|)`), pvalue_nog = as.data.frame(summary(mod_nog)$coefficients)[2,] %>% pull(`Pr(>|t|)`), r2.lmer=Mr2.lmer, r2type="M", r2.lmer_nog=Mr2.lmer_nog, r2nogtype="M"))
    )
    
        if(!is.na(Cr2.lmer) & is.na(Cr2.lmer_nog)) (
       correlation_strength_results <- bind_rows(correlation_strength_results, data.frame(annual_climvar = annual_climvar[i], prov_climvar = prov_climvar[i], pvalue_all = as.data.frame(summary(mod)$coefficients)[2,] %>% pull(`Pr(>|t|)`), pvalue_nog = as.data.frame(summary(mod_nog)$coefficients)[2,] %>% pull(`Pr(>|t|)`), r2.lmer=Cr2.lmer, r2type="C", r2.lmer_nog=Mr2.lmer_nog, r2nogtype="M"))
    )
        if(is.na(Cr2.lmer) & !is.na(Cr2.lmer_nog)) (
       correlation_strength_results <- bind_rows(correlation_strength_results, data.frame(annual_climvar = annual_climvar[i], prov_climvar = prov_climvar[i], pvalue_all = as.data.frame(summary(mod)$coefficients)[2,] %>% pull(`Pr(>|t|)`), pvalue_nog = as.data.frame(summary(mod_nog)$coefficients)[2,] %>% pull(`Pr(>|t|)`), r2.lmer=Mr2.lmer, r2type="M", r2.lmer_nog=Cr2.lmer_nog, r2nogtype="C"))
    )
