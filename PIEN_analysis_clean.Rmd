...
newmod <- glmmTMB(cbind(n_cones, total-n_cones) ~  height + (1|BLK) + (1|year) + (1|Prov), data= moniger_subset_nog, family = binomial)
summary(newmod)
...
summary(best.mod.cone.clim_nog)
predict(best.mod.cone.clim_nog, newdata=data.frame(height=3.85),type="response")
