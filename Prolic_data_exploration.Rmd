...
allmod <- lmer(rw ~ ppt_sm + ppt_gs + ppt_wt + ppt_fa + ppt_sp + ppt + value_sm_tmax + value_sm_tmean + value_sm_tmin + value_fa_tmax + value_fa_tmean + value_fa_tmin + value_wt_tmax + value_wt_tmean + value_wt_tmin + value_sp_tmax +value_sp_tmean + value_sp_tmin + vpdmax_sm + vpdmax_fa + vpdmax_wt + vpdmax_sp+FDSI +aet_sum+cwd_sum  + (1|tree) + (1|tree:Provenance), data=rw_clim_wide_formodel)
summary(allmod)
